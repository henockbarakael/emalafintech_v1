...
class CreatePermissionListsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('permission_lists')->insert([
            ['permission_name'=>'Administrateur','read'=>'Y','write'=>'Y','create'=>'Y','delete'=>'Y','import'=>'Y','export'=>'Y'],
            ['permission_name'=>'Utilisateur','read'=>'Y','write'=>'Y','create'=>'Y','delete'=>'N','import'=>'N','export'=>'N'],
            ['permission_name'=>'Caissier','read'=>'Y','write'=>'Y','create'=>'Y','delete'=>'N','import'=>'N','export'=>'N'],
