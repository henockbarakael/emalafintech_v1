                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">{{ Auth::user()->firstname." ".Auth::user()->name }}</h3>
                                                <h6 class="text-muted">{{ Auth::user()->role_name }} chez Lumumba & Partners</h6>
                                                <small class="text-muted">{{ Auth::user()->position }}</small>
                                                <div class="staff-id">Matricule : {{ Auth::user()->rec_id }}</div>
                                                <div class="small doj text-muted">Date d'inscription : {{ Auth::user()->join_date }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                                ...
                                                @if(!empty($information))
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            ...
                                                            <a href="profile.html">
                                                                {{ Auth::user()->firstanme." ".Auth::user()->name }}
                                                            </a>
                                                        </div>
                                                    </li>
                                                @else
                                    ...
                                    <ul class="personal-info">
                                        @if(!empty($personnal_information))
                                            <li>
                                                ...
                                                <div class="text">{{$personnal_information->card_type }}</div>
                                            </li>
                                            <li>
                                                <div class="title">N° de passeport: </div>
                                                <div class="text">{{$personnal_information->card_id }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Date d'expiration: </div>
                                                <div class="text">{{$personnal_information->card_exp_date }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Commune: </div>
                                                <div class="text">{{$personnal_information->township }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Ville: </div>
                                                <div class="text">{{$personnal_information->city }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Pays: </div>
                                                <div class="text">{{$personnal_information->nationality }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Etat civil: </div>
                                                <div class="text">{{$personnal_information->marital_status }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Nombre d'enfants: </div>
                                                <div class="text">{{$personnal_information->no_children }}</div>
                                            </li>
                                        @else
                                            <li>
                                                <div class="title">Carte d'identité:</div>
                                    ...
                                    @if (!empty($emergency_information))
                                        ...
                                        <ul class="personal-info">
                                            <li>
                                                ...
                                                <div class="text">{{($emergency_information->emergency_fullname1)}}</div>
                                            </li>
                                            <li>
                                                <div class="title">Lien de parenté</div>
                                                <div class="text">{{($emergency_information->relationship1) }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Téléphone </div>
                                                <div class="text">{{($emergency_information->emergency_phone1) }}</div>
                                            </li>
                                        </ul>
                                        <hr>
                                        ...
                                        <ul class="personal-info">
                                            <li>
                                                <div class="title">Nom complet</div>
                                                <div class="text">{{($emergency_information->emergency_fullname2) }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Lien de parenté</div>
                                                <div class="text">{{($emergency_information->relationship2) }}</div>
                                            </li>
                                            <li>
                                                <div class="title">Téléphone </div>
                                                <div class="text">{{($emergency_information->emergency_phone2) }}</div>
                                            </li>
                                        </ul>
                                    @else
                                        <h5 class="section-title">Contact 1</h5>
                                    ...
                                    <ul class="personal-info">
                                        @if (!empty($bank_information))
                                            <li>
                                                ...
                                                <div class="text">{{($bank_information->bank_name)}}</div>
                                            </li>
                                            <li>
                                                <div class="title">Numéro du compte</div>
                                                <div class="text">{{($bank_information->account_no)}}</div>
                                            </li>
                                            <li>
                                                <div class="title">Code IFSC </div>
                                                <div class="text">{{($bank_information->ifsc_code)}}</div>
                                            </li>
                                            <li>
                                                <div class="title">Numéro PAN</div>
                                                <div class="text">{{($bank_information->pan_no)}}</div>
                                            </li>
                                        @else
                                            <li>
                                                <div class="title">Banque: </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($family_information as $family_information)
                                                <tr>
                                                    <td>{{($family_information->fullname)}}</td>
                                                    <td>{{($family_information->relationship)}}</td>
                                                    <td>{{($family_information->phone)}}</td>
                                                </tr>
                                                @endforeach
                                                @else
                                                    <tr>
