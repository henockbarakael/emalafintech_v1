...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">SOLDE AGENCE</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-header">
                        ...
                        <p class="card-text">
                            Le tableau ci-dessous affiche la liste de toutes les <code>agences</code> avec leur solde. Il est possible d'exporter le fchier au format désiré.
                            <br>
                            En cliquant sur l'icône <i class="fa fa-cloud-upload"></i>, il est possible de recharger le solde d'une agence.
                        </p>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example1" class="table table-striped custom-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Balance CDF</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm" href="{{ url('approvisionnement/agence/'.$agence->numero_a) }}"><i class="fa fa-cloud-upload"></i> Recharger</a>
                                            {{-- <a class="btn btn-purple btn-sm agenceEdit" data-toggle="modal"  data-target="#edit_agence"><i class="fa fa-pencil"></i></a> --}}
                                            {{-- <a class="btn btn-info btn-sm agenceDelete" href="#" data-toggle="modal"  data-target="#delete_user"><i class="fa fa-trash-o"></i></a> --}}
                                            {{-- <a hidden class="id" href="#" data-toggle="modal"  data-target="#delete_user">{{ $agence->id }}</a> --}}
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
        ...
        <!-- Edit User Modal -->
        <div id="edit_agence" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Modifier une agence</h5>
                        ...
                        <form action="{{ route('agence/update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12">
                                ...
                                <label>Ville</label>
                                    ...
                                    <input class="form-control" type="text" id="e_ville" name="ville" >
                            </div>
                        </div>
                            <br>
                            <div class="submit-section">
