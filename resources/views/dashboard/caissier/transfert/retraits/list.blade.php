                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Vérification</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="{{url('transfert/retraits/bordereau/'.$transactions->transaction_id)}}" class="btn add-btn" ><i class="fa fa-plus"></i> Générer un bordereau</a>
                    </div>
                </div>
            </div>
            <div class="row">
