...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('emala.sending') }}" method="POST">
                        @csrf
                        <div class="card-box">
                            <p><b>TRANSACTION</b></p>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Montant / Amount <span class="text-danger">*</span></label>
                                    <input name="amount" class="form-control @error('amount') is-invalid @enderror" type="text" placeholder="" value="{{ old('amount') }}">
                                    @error('amount')
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select @error('currency') is-invalid @enderror" name="currency" value="{{ old('currency') }}">
                                        <option >Choisir une devise</option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input name="d_city" class="form-control @error('d_city') is-invalid @enderror" type="text" placeholder="" value="{{ old('d_city') }}">
                                    @error('d_city')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select @error('country_dest') is-invalid @enderror" name="country_dest" value="{{ old('country_dest') }}">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <label>Motif de la transaction <span class="text-danger">*</span></label>
                                    <input name="motif" class="form-control @error('motif') is-invalid @enderror" type="text" placeholder="" value="{{ old('motif') }}">
                                    @error('motif')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="card-box">
                            <p><b>EXPÉDITEUR / SENDER</b></p>
                        </div>
                        <div class="row">

                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Prénoms / First and Middle Name <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Date de naissance / Date of Birth <span class="text-danger">*</span></label>
                                    <input name="birthday" class="form-control @error('birthday') is-invalid @enderror" type="date" placeholder="" value="{{ old('birthday') }}">
                                    @error('birthday')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Pays de Naissance/Country of Birth</label>
                                    <select class="form-control select @error('country_dest') is-invalid @enderror" name="country_sender" value="{{ old('country_dest') }}">
                                        <option >Choisir un pays</option>
                                        <option value="AFG">Afghanistan</option>
                                        <option value="ALA">Åland Islands</option>
                                        <option value="ALB">Albanie</option>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input name="address" class="form-control @error('address') is-invalid @enderror" placeholder="" type="text" value="{{ old('address') }}">
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Pièce d'identité/ Identity card</label>
                                    <input name="identity_card" class="form-control @error('identity_card') is-invalid @enderror" placeholder="" type="text" value="{{ old('identity_card') }}">
                                    @error('identity_card')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Numéro pièce d'identité/ ID number</label>
                                    <input name="id_number" class="form-control @error('id_number') is-invalid @enderror" placeholder="" type="text" value="{{ old('id_number') }}">
                                    @error('id_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="card-box">
                            <p><b>DESTINATAIRE / RECEIVER (tel qu’indiqué sur sa pièce d’identité)</b></p>
                        </div>
                        <div class="row">

                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Prénom  / Firstname (As shown on ID) <span class="text-danger">*</span></label>
                                    <input name="firstname_dest" class="form-control @error('firstname_dest') is-invalid @enderror" type="text" placeholder="" value="{{ old('firstname_dest') }}">
                                    @error('firstname_dest')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Nom / Family name (As shown on ID)</label>
                                    <input name="lastname_dest" class="form-control @error('lastname_dest') is-invalid @enderror" placeholder="" type="text" value="{{ old('lastname_dest') }}">
                                    @error('lastname_dest')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Postnom / Middlename (As shown on ID)</label>
                                    <input name="middlename_dest" class="form-control @error('middlename_dest') is-invalid @enderror" placeholder="" type="text" value="{{ old('middlename_dest') }}">
                                    @error('middlename_dest')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>No. de téléphone de contact <span class="text-danger">*</span></label>
                                    <input name="d_phone" class="form-control @error('d_phone') is-invalid @enderror" type="text" placeholder="" value="{{ old('d_phone') }}">
                                    @error('d_phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="submit-section">
                            <button type="submit" class="btn btn-primary submit-btn">Valider le transfert</button>
                        </div>
                    </form>
                </div>
            </div>
