        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Agence: {{$gerants->code_a}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('gerant.dashboard')}}">Chef d'agence</a></li>
                            <li class="breadcrumb-item"><a href="{{route('gerant.dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Liste de comptes</li>
                        </ul>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="{{route('compte.caisse')}}" class="btn add-btn" ><i class="fa fa-plus"></i> Ajouter un compte</a>
                        ...
                        <table class="table table-striped custom-table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Téléphone</th>
                                    <th>E-mail</th>
                                    <th class="text-nowrap">No. compte</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{++$key}}</td>
                                    <td>{{$value->a_fullname}}</td>
                                    <td>{{$value->a_phone}}</td>
                                    <td>{{$value->a_email}}</td>
                                    <td>{{$value->compte_id}}</td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                                <a class="btn btn-dark btn-sm" href="#" data-toggle="modal" data-target="#edit_caissier"><i class="fa fa-pencil m-r-5"></i></a>
