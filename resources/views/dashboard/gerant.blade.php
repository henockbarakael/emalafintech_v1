    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            {{-- <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        @auth<h3 class="page-title" style="font-size: 14px; color:midnightblue">Welcome in your dashboard {{Auth::user()->name}}</h3>@endauth
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Emala</a></li>
                            <li class="breadcrumb-item"><a class="" href="{{ route('home') }}">Accueil</a></li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="card">
                        <div class="card-body text-center">
                            <h3><b>{{$solde_usd->solde_usd}}</b></h3>
                            <p>Solde agence USD</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
