    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="">
                    <a href="<?php echo e(route('caissier.dashboard')); ?>"><i class="la la-dashboard"></i> <span> Tableau de bord</span></a>
                </li>
                <li class="menu-title"> <span>Transfert d'argent</span> </li>
                <li>
                    <a href="<?php echo e(route('emala.sending.form')); ?>"><i class="fa fa-exchange"></i> <span>Envoi d'argent</span></a>
                </li>
                <li>
                    <a href="<?php echo e(route('emala.withdrawal.form')); ?>"><i class="fa fa-exchange"></i> <span>Retrait d'argent</span></a>
                </li>
                <li class="menu-title"> <span>Rechargement compte</span> </li>
                <li class="">
                    <a href="<?php echo e(route('caissier.emala.all')); ?>" ><i class="fa fa-calculator"></i><span> Balance Solde </span></a>
                </li>
                <li class="submenu">
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li><a href="<?php echo e(route('caissier.emala.all')); ?>">Toutes</a></li>
                ...
                <li class="menu-title">
                    ...
                    <li class="">
                        <a href="<?php echo e(route('profile_caissier')); ?>" ><i class="fa fa-envelope-o"></i><span> Mon compte </span> </a>
                </li>
            </ul>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/hr_ms_laravel8-main/resources/views/layouts/ca_sidebar.blade.php ENDPATH**/ ?>