...
<head>
	...
	<meta name="description" content="Système de gestion financière pour tous.">
	<meta name="keywords" content="emala, emalafintech, fintech">
	...
	<meta name="author" content="Emala Fintech">
	<meta name="robots" content="noindex, nofollow">
	<title>Dashboard - EMALA</title>
	<!-- Favicon -->
    ...
    <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo e(URL::to('plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('plugins/datatables-buttons/css/buttons.bootstrap4.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('assets/css/line-awesome.min.css')); ?>">
<!--Themify Icons-->
<link rel="stylesheet" href="<?php echo e(asset('icon/themify-icons/themify-icons.css')); ?>">
<!--Ion Icons-->
<link rel="stylesheet" href="<?php echo e(asset('icon/ion-icon/css/ionicons.min.css')); ?>">
...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="header">
			...
			<div class="page-title-box">
				<h3 style="font-size: 15px; margin-top: 5px">Bienvenue dans la plateforme <a href="https://emalafintech.net">EmalaFintech</a></h3>
			</div>
			<!-- /Header Title -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                        <img src="<?php echo e(asset('assets/img/flags/fr.png')); ?>" alt="" height="20"> <span>French</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="<?php echo e(asset('assets/img/flags/fr.png')); ?>" alt="" height="16"> French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
						...
						<div class="noti-content">
							<ul class="notification-list">
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-02.jpg')); ?>">
												</span>
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-03.jpg')); ?>">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-06.jpg')); ?>">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-17.jpg')); ?>">
												</span>
											<div class="media-body">
								...
								<li class="notification-message">
									<a href="activities.html">
										<div class="media"> <span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-13.jpg')); ?>">
												</span>
											<div class="media-body">
							...
							<ul class="notification-list">
									...
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left"> <span class="avatar">
														<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-09.jpg')); ?>">
													</span> </div>
								...
								<li class="notification-message">
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left"> <span class="avatar">
														<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-05.jpg')); ?>">
													</span> </div>
								...
								<li class="notification-message">
									<a href="chat.html">
										<div class="list-item">
											<div class="list-left">
												<span class="avatar">
													<img alt="" src="<?php echo e(URL::to('assets/img/profiles/avatar-08.jpg')); ?>">
												</span>
											</div>
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="<?php echo e(route('profile_user')); ?>">Mon Profil</a>
    ...
    <script src="<?php echo e(URL::to('plugins/datatables-buttons/js/dataTables.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/datatables-buttons/js/buttons.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/jszip/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/pdfmake/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/pdfmake/vfs_fonts.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/datatables-buttons/js/buttons.html5.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/datatables-buttons/js/buttons.print.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('plugins/datatables-buttons/js/buttons.colVis.min.js')); ?>"></script>
...
<?php /**PATH /var/www/html/hr_ms_laravel8-main/resources/views/layouts/master.blade.php ENDPATH**/ ?>