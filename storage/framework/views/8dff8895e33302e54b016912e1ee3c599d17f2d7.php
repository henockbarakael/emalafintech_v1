                                ...
                                <table id="example1" class="table table-bordered table-stripped mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="type"><?php echo e($role->role_type); ?></td>
                                            <td hidden class="id"><?php echo e($role->id); ?></td>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo e(route('all/roles/save')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/hr_ms_laravel8-main/resources/views/configuration/roles/all.blade.php ENDPATH**/ ?>